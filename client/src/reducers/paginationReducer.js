...
const SET_MEALS_PAGINATION = 'SET_MEALS_PAGINATION';
const SET_CATERER_MEALS_PAGINATION = 'SET_CATERER_MEALS_PAGINATION';
const SET_CATERER_DASHBOARD_ORDERS_PAGINATION = 'SET_CATERER_DASHBOARD_ORDERS_PAGINATION';
const SET_DASHBOARD_ORDERS_PAGINATION = 'SET_DASHBOARD_ORDERS_PAGINATION';
const SET_MENU_PAGINATION = 'SET_MENU_PAGINATION';
